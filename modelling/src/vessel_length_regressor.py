...
class VesselLengthRegressor:
    ...
    def calculate_metrics(self, y_true: np.ndarray, y_pred: np.ndarray) -> Dict[str, float]:
        ...
        Returns:
            Dictionary with MAE, RMSE, R², and VLA metrics
        """
        # Calculate VLA (Vessel Length Accuracy)
    ...
    def plot_results(self, plot_data: Dict) -> None:
        ...
        """
        # Training plot
        self._create_single_plot(                              # added later
            plot_data['train_true'], plot_data['train_pred'], 
            plot_data['train_metrics'], 'Training',
            plot_data.get('train_classes')
        )

        # Validation plot
        self._create_single_plot(
            plot_data['val_true'], plot_data['val_pred'], 
            plot_data['val_metrics'], 'Validation',
            plot_data.get('val_classes')
        )
        
        # Test plot
        self._create_single_plot(
            plot_data['test_true'], plot_data['test_pred'], 
