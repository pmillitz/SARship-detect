...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Match .txt label files with vessel lengths from CSV lookup')
    parser.add_argument('--input_csv_path', required=True, help='Path to df_labels_train_filt.csv')
    parser.add_argument('--label_dir', required=True, help='Directory containing .txt label files')
    ...
    # Run the matching
    result = match_label_with_vessel_lengths(args.input_csv_path, args.label_dir, args.output_csv_path, args.logfile)
